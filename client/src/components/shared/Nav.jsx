...
function Nav ({user}) {
  return (
    ...
    <Link className="navbar-brand" to="/">HotDeals!</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="blogsDropdown">
              <Link to="/deals" className="dropdown-item">Hot Deals</Link>

              {user ? (
                <Fragment>
                  <div className="dropdown-divider"></div>
                  <Link to="/deals/new" className="dropdown-item">New Deal</Link>
                </Fragment>
              ) : null}
            </div>
          </li>
